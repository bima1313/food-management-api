...
public class RestaurantControllerTest {
        ...
        void getMerchantRestaurantsSuccess() throws Exception {
                ...
                mockMvc.perform(get(RestaurantConstants.MERCHANT_BASE_PATH)
                                ...
                                .andExpectAll(
                                                status().isOk())
                                .andDo(result -> {
                                        WebResponse<MerchantRestaurantsResponse> response = objectMapper.readValue(
                                                        result.getResponse().getContentAsString(),
                                                        new TypeReference<WebResponse<MerchantRestaurantsResponse>>() {
                                                        });
                                        assertNull(response.getError());
        ...
        @Test
        void getMerchantRestaurantNotFound() throws Exception {
                String randomInputRestaurantId = "GkiOiJjNmQ4YTM4My1hjMzMzQsIm5iZiI6MTc2ODE1v817U2m86GDrfy0hsg4a";
                User user = new User();
                user.setId("eyJhbfaGkiJIUIkRjCJ9");
                user.setToken("eyJhbGciOiJIUzM4NCJ9.eyJqdGkiOiJjNmQ4YTM4My1hYWQ3LTQ4N2UtODBhZS00NWY5ZjViZTg3MzgiLCJpc3MiOiJmb29kLW1hcmtldCIsInN1YiI6ImhlbGxvd29ybGQiLCJhdWQiOlsidXNlciJdLCJleHAiOjE3Njg3NjMzMzQsIm5iZiI6MTc2ODE1ODUzNCwiaWF0IjoxNzY4MTU4NTM0fQ.KFtqJoo7X75a10BSoLRav6v817U2m86GDrfy0hsg4a148TK3IWX-57VIWoka1qb3");
                user.setTokenExpiredAt(1768763335093L);
                userRepository.save(user);
                mockMvc.perform(get(RestaurantConstants.MERCHANT_BASE_PATH + "/{restaurantId}", randomInputRestaurantId)
                                .header("Authorization", "Bearer " + user.getToken())
                                .accept(MediaType.APPLICATION_JSON))
                                .andExpectAll(
                                                status().isNotFound())
        ...
        @Test
        void getMerchantRestaurantSuccess() throws Exception {
                User user = new User();
                user.setId("eyJhbfaGkiJIUIkRjCJ9");
                user.setToken("eyJhbGciOiJIUzM4NCJ9.eyJqdGkiOiJjNmQ4YTM4My1hYWQ3LTQ4N2UtODBhZS00NWY5ZjViZTg3MzgiLCJpc3MiOiJmb29kLW1hcmtldCIsInN1YiI6ImhlbGxvd29ybGQiLCJhdWQiOlsidXNlciJdLCJleHAiOjE3Njg3NjMzMzQsIm5iZiI6MTc2ODE1ODUzNCwiaWF0IjoxNzY4MTU4NTM0fQ.KFtqJoo7X75a10BSoLRav6v817U2m86GDrfy0hsg4a148TK3IWX-57VIWoka1qb3");
                user.setTokenExpiredAt(1768763335093L);
                ...
                mockMvc.perform(get(RestaurantConstants.MERCHANT_BASE_PATH + "/{restaurantId}", restaurant.getId())
                                .header("Authorization", "Bearer " + user.getToken())
                                .accept(MediaType.APPLICATION_JSON))
                                .andExpectAll(
                                                status().isOk())
                                .andDo(result -> {
                                        ...
                                        assertNull(response.getError());
                                        assertNotNull(response.getData().getRestaurant());
                                });
        }
}
